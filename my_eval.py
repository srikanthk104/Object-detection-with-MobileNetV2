...
parser.add_argument('-b', '--batch-size', default=4, type=int,
                    metavar='N',help='input batch size for training (default: 20')
...
transform=transforms.Compose([transforms.ToTensor(),transforms.Normalize(mean=MEAN_COEF,std=DIV_COEF)])
...
def imshow(img):
    npimg = img * np.array(DIV_COEF).reshape([3,1,1]) \
